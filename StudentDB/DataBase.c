#include                   "functions.h"
/*======                   (student      0)         ======
students[0].sudent.id      =             000000;
students[0].sudent.year    =             2023;
students[0].course[0].id   =             0000;
...
/*======                   (student      1)         ======
students[1].sudent.id      =             111111;
students[1].sudent.year    =             2023;
students[1].course[0].id   =             0000;
...
/*======                   (student      2)         ======
students[2].sudent.id      =             222222;
students[2].sudent.year    =             2023;
students[2].course[0].id   =             0000;
...
/*======                   (student      3)         ======
students[3].sudent.id      =             333333;
students[3].sudent.year    =             2023;
students[3].course[0].id   =             0000;
...
/*======                   (student      4)         ======
students[4].sudent.id      =             444444;
students[4].sudent.year    =             2022;
students[4].course[0].id   =             0000;
...
/*======                   (student      5)         ======
students[5].sudent.id      =             555555;
students[5].sudent.year    =             2022;
students[5].course[0].id   =             0000;
...
/*======                   (student      6)         ======
students[6].sudent.id      =             666666;
students[6].sudent.year    =             2022;
students[6].course[0].id   =             0000;
...
/*======                   (student      7)         ======
students[7].sudent.id      =             777777;
students[7].sudent.year    =             2022;
students[7].course[0].id   =             0000;
...
students[7].student_state  =             exist;
/*======                   (student      8)         ======
students[8].sudent.id      =             888888;
students[8].sudent.year    =             2022;
students[8].course[0].id   =             0000;
...
/*======                   (student      9)         ======
students[9].sudent.id      =             999999;
students[9].sudent.year    =             2022;
students[9].course[0].id   =             0000;
